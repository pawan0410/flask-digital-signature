var zkSignatureFour = (function () {
	...
	return {
		//public functions
		capture: function (){
				var parent = document.getElementById("canvas4");
				parent.childNodes[0].nodeValue = "";

				var canvasArea = document.createElement("canvas");
				canvasArea.setAttribute("id", "newSignature4");
				parent.appendChild(canvasArea);

				var canvas = document.getElementById("newSignature4");
...
//				}
		...
		save : function(){
				...
				var canvas = document.getElementById("newSignature3");
				// save canvas image as data url (png format by default)
				var dataURL = canvas.toDataURL("image/png");
				document.getElementById("saveSignature3").src = dataURL;
		...
		clear : function(){
				...
				var parent = document.getElementById("canvas4");
				var child = document.getElementById("newSignature4");

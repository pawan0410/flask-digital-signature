var zkSignatureTwo = (function () {
	...
	return {
		//public functions
		capture: function (){
				var parent = document.getElementById("canvas2");
				parent.childNodes[0].nodeValue = "";

				var canvasArea = document.createElement("canvas");
				canvasArea.setAttribute("id", "newSignature2");
...
//				}
		...
		clear : function(){
				...
				var child = document.getElementById("newSignature2");

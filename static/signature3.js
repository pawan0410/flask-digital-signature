var zkSignatureThree = (function () {
	...
	return {
		//public functions
		capture: function (){
				var parent = document.getElementById("canvas3");
				parent.childNodes[0].nodeValue = "";

				var canvasArea = document.createElement("canvas");
				canvasArea.setAttribute("id", "newSignature3");
...
//				}
		...
		clear : function(){
				...
				var child = document.getElementById("newSignature3");
